...
export const WORKSPACE_PAGES: Record<WorkspacePageKey, WorkspacePage> = {
  command: { segment: "command", icon: "Gauge", navKey: "command" },
  ...
  workflow: { segment: "workflow", icon: "Workflow", navKey: "workflow" },
  outcomes: { segment: "outcomes", icon: "FileCheck2", navKey: "outcomes" },
  organization: { segment: "organization", icon: "Building2", navKey: "organization" },
  ...
  workrooms: { segment: "workrooms", icon: "MessageSquare", navKey: "workrooms" },
  workWall: { segment: "work-wall", icon: "Monitor", navKey: "workWall" },
  employees: { segment: "employees", icon: "Users", navKey: "employees" },
  datasets: { segment: "datasets", icon: "FileText", navKey: "datasets" },
  bases: { segment: "bases", icon: "Server", navKey: "bases" },
