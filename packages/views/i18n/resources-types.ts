...
import type outcomes from "../locales/en/outcomes.json";
import type organization from "../locales/en/organization.json";
...
import type bases from "../locales/en/bases.json";
