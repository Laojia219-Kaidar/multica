 ...
 *     2. Find-or-create a "HiveCrew Helper" agent on the picked runtime
...
const LEGACY_HELPER_AGENT_NAMES = new Set(["Multica Helper"]);
    ...
    const found = agents.find(
      (a) =>
        (a.name === HELPER_AGENT_NAME ||
          LEGACY_HELPER_AGENT_NAMES.has(a.name)) &&
