...
- Current Phase: WAVE-0 current truth (calibration done) -> WAVE-1 (contract + red tests)
...
- Next action: spawn 3 non-overlapping read-only sub-agents; integrate their reports; author red tests; start Slice 1
