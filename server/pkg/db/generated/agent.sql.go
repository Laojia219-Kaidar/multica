...
WHERE id = $1
RETURNING id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, composio_toolkit_allowlist, permission_mode, kind, system_key, disabled_runtime_skills, service_tier, operational_mode, home_base_id, fallback_base_id
`
...
type CancelDeferredEscalationsForIssueAgentRow struct {
	...
	WriterLeaseClaimMode      pgtype.Text        `json:"writer_lease_claim_mode"`
	WriterLeaseTargetSnapshot []byte             `json:"writer_lease_target_snapshot"`
...
const cancelOpenReviewTasksForIssue = `-- name: CancelOpenReviewTasksForIssue :many
UPDATE agent_task_queue
...
func (q *Queries) CancelOpenReviewTasksForIssue(ctx context.Context, issueID pgtype.UUID) ([]AgentTaskQueue, error) {
	rows, err := q.db.Query(ctx, cancelOpenReviewTasksForIssue, issueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ClaimAgentTaskParams struct {
	...
	TrainingEligibleOnly bool        `json:"training_eligible_only"`
}
...
const completeReviewTask = `-- name: CompleteReviewTask :one
UPDATE agent_task_queue
...
type CompleteReviewTaskParams struct {
	Result []byte      `json:"result"`
	ID     pgtype.UUID `json:"id"`
}
...
func (q *Queries) CompleteReviewTask(ctx context.Context, arg CompleteReviewTaskParams) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, completeReviewTask, arg.Result, arg.ID)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
...
const countOpenReviewTasks = `-- name: CountOpenReviewTasks :one
...
func (q *Queries) CountOpenReviewTasks(ctx context.Context, agentID pgtype.UUID) (int64, error) {
	row := q.db.QueryRow(ctx, countOpenReviewTasks, agentID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
SELECT
    ...
    $6, $7, $8, 'unattributed'::text, 'issue_delivery'::text, $5
WHERE NOT EXISTS (
    SELECT 1
...
SELECT id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, custom_env, custom_args, mcp_config, model, thinking_level, composio_toolkit_allowlist, permission_mode, kind, system_key, disabled_runtime_skills, service_tier, operational_mode, home_base_id, fallback_base_id FROM agent
WHERE id = $1
`
...
const getOpenRepairTaskForIssue = `-- name: GetOpenRepairTaskForIssue :one
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, session_rollout_missing, retired_session_id, task_kind, review_target_task_id, writer_lease_claim_mode, writer_lease_target_snapshot, writer_lease_target_digest FROM agent_task_queue
WHERE issue_id = $1
...
func (q *Queries) GetOpenRepairTaskForIssue(ctx context.Context, issueID pgtype.UUID) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, getOpenRepairTaskForIssue, issueID)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
...
const getOpenReviewTaskForIssue = `-- name: GetOpenReviewTaskForIssue :one
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, session_rollout_missing, retired_session_id, task_kind, review_target_task_id, writer_lease_claim_mode, writer_lease_target_snapshot, writer_lease_target_digest FROM agent_task_queue
WHERE issue_id = $1
  AND task_kind = 'review'
  AND status IN ('queued', 'dispatched', 'running', 'waiting_local_directory')
...
func (q *Queries) GetOpenReviewTaskForIssue(ctx context.Context, issueID pgtype.UUID) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, getOpenReviewTaskForIssue, issueID)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
...
const getRepairTaskByEvidence = `-- name: GetRepairTaskByEvidence :one
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, session_rollout_missing, retired_session_id, task_kind, review_target_task_id, writer_lease_claim_mode, writer_lease_target_snapshot, writer_lease_target_digest FROM agent_task_queue
WHERE issue_id = $1
  AND task_kind = 'repair'
...
type GetRepairTaskByEvidenceParams struct {
	IssueID              pgtype.UUID `json:"issue_id"`
	TriggerEvidenceRefID pgtype.UUID `json:"trigger_evidence_ref_id"`
}
...
func (q *Queries) GetReviewTaskForUpdate(ctx context.Context, id pgtype.UUID) (AgentTaskQueue, error) {
...
const listReviewerCandidates = `-- name: ListReviewerCandidates :many
SELECT
    a.id,
    a.workspace_id,
    a.name,
...
type ListReviewerCandidatesParams struct {
	WorkspaceID pgtype.UUID `json:"workspace_id"`
	ID          pgtype.UUID `json:"id"`
}

type ListReviewerCandidatesRow struct {
	ID              pgtype.UUID `json:"id"`
	WorkspaceID     pgtype.UUID `json:"workspace_id"`
	Name            string      `json:"name"`
	RuntimeID       pgtype.UUID `json:"runtime_id"`
	OpenReviewTasks int64       `json:"open_review_tasks"`
}
...
func (q *Queries) ListReviewerCandidates(ctx context.Context, arg ListReviewerCandidatesParams) ([]ListReviewerCandidatesRow, error) {
	rows, err := q.db.Query(ctx, listReviewerCandidates, arg.WorkspaceID, arg.ID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListReviewerCandidatesRow{}
	for rows.Next() {
		var i ListReviewerCandidatesRow
		if err := rows.Scan(
			&i.ID,
			&i.WorkspaceID,
			&i.Name,
...
const lockAgentTaskForCompletion = `-- name: LockAgentTaskForCompletion :one
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, session_rollout_missing, retired_session_id, task_kind, review_target_task_id, writer_lease_claim_mode, writer_lease_target_snapshot, writer_lease_target_digest FROM agent_task_queue
WHERE id = $1
FOR UPDATE
`
...
func (q *Queries) LockAgentTaskForCompletion(ctx context.Context, id pgtype.UUID) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, lockAgentTaskForCompletion, id)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
...
const persistWriterLeaseClaimSnapshot = `-- name: PersistWriterLeaseClaimSnapshot :execrows
UPDATE agent_task_queue
SET writer_lease_claim_mode = $1,
    writer_lease_target_snapshot = $2::jsonb,
    writer_lease_target_digest = $3
WHERE id = $4
  AND runtime_id = $5
  AND dispatched_at = $6
  ...
  AND (
      ...
      OR
      (writer_lease_claim_mode = $1
       AND writer_lease_target_snapshot = $2::jsonb
       AND writer_lease_target_digest = $3)
  )
`

type PersistWriterLeaseClaimSnapshotParams struct {
	ClaimMode      pgtype.Text        `json:"claim_mode"`
	TargetSnapshot []byte             `json:"target_snapshot"`
	TargetDigest   pgtype.Text        `json:"target_digest"`
...
func (q *Queries) PersistWriterLeaseClaimSnapshot(ctx context.Context, arg PersistWriterLeaseClaimSnapshotParams) (int64, error) {
	result, err := q.db.Exec(ctx, persistWriterLeaseClaimSnapshot,
		arg.ClaimMode,
		arg.TargetSnapshot,
		arg.TargetDigest,
		arg.TaskID,
...
const stampCompletedReviewTaskVerdict = `-- name: StampCompletedReviewTaskVerdict :one
UPDATE agent_task_queue
SET result = $1::jsonb
WHERE id = $2
  AND task_kind = 'review'
...
type StampCompletedReviewTaskVerdictParams struct {
	Result []byte      `json:"result"`
	ID     pgtype.UUID `json:"id"`
}
...
func (q *Queries) StampCompletedReviewTaskVerdict(ctx context.Context, arg StampCompletedReviewTaskVerdictParams) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, stampCompletedReviewTaskVerdict, arg.Result, arg.ID)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
