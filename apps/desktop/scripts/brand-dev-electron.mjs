...
// shows "HiveCrew Canary" in the menu bar, Cmd+Tab switcher, and
...
// "HiveCrew Canary <suffix>" — distinguishable in Cmd+Tab and matching the app
...
const DESIRED_NAME = process.env.DESKTOP_APP_SUFFIX
  ? `HiveCrew Canary ${process.env.DESKTOP_APP_SUFFIX}`
  : "HiveCrew Canary";
